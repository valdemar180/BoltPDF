  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4">
      <div
        ...
        className={`w-full h-80 rounded-2xl border-2 border-dashed flex flex-col items-center justify-center p-8 text-center cursor-pointer transition-all duration-300 backdrop-blur-sm
          ${isDragging 
      ...
      >
        ...
        {!file ? (
          <>
            {/* ÍCONE CORRIGIDO DA NUVEM (TAMANHO CONTROLADO) */}
          ...
          <div className="flex flex-col items-center">
            {/* ÍCONE DO ARQUIVO PDF SELECIONADO */}
      ...
      {error && (
        <div className="mt-4 p-3 bg-red-950/30 border border-red-900/50 rounded-xl text-center">
