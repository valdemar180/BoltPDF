      ...
      >
        ...
        {isProcessing ? (
          ...
          <>
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Arrastar e soltar seus arquivos PDF ou imagens aqui</h3>
            <p className="text-sm text-gray-500 max-w-xs">ou clique para navegar nos seus arquivos locais (Pode selecionar vários)</p>
          </>
        ) : (
          <div className="flex flex-col items-center">
